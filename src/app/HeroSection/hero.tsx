export default function HeroSection() {
    return (
        <div className="flex p-15 pt-24 pb-24 bg-black text-white items-center poppins-regular">
            ...
            <div className="w-2/3 items-center font-medium poppins-regular">
                <h1 className="self-center text-9xl">Benaya Simamora</h1>
